...
yay -Sy --needed --noconfirm gnome gnome-tweaks gnome-extension gnome-browser-connector gnome-shell-extensions qt5-styleplugins breeze breeze-gtk
...
yay -Sy --needed  --noconfirm ffmpeg vlc neofetch openvpn google-chrome usb_modeswitch update-grub gthumb nufraw
